...
export default function ContactoPage() {
  ...
  const wa3 = 'https://wa.me/16893063870?text=' + encodeURIComponent('Hola, quiero más información.');
    ...
    <>
      ...
      <section className="section py-16">
        ...
        <p className="text-brand-500 text-center mb-12">
          Estamos para ayudarte. Escríbenos por WhatsApp o correo para más información o para
          ...
          <div className="card p-6">
            ...
            <div className="space-y-3">
              ...
              <a href={wa3} target="_blank" rel="noreferrer" className="btn-whatsapp w-full justify-center">
                +1 (689) 306-3870 (EE. UU.)
              </a>
            </div>

            <div className="mt-6 pt-6 border-t border-brand-100">
              <h2 className="font-display text-xl font-semibold text-brand-700 mb-3">✉️ Correo</h2>
            ...
            <div className="mt-6 pt-6 border-t border-brand-100">
              <h2 className="font-display text-xl font-semibold text-brand-700 mb-3">📍 Oficina (EE. UU.)</h2>
